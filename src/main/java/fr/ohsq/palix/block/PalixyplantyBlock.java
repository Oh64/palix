...
import fr.ohsq.palix.procedures.PalixyplantyQuandLaPlanteEstDetruiteParUnJoueurProcedure;
import fr.ohsq.palix.itemgroup.PalixongletItemGroup;
import fr.ohsq.palix.PalixModElements;

@PalixModElements.ModElement.Tag
public class PalixyplantyBlock extends PalixModElements.ModElement {
	@ObjectHolder("palix:palixy_planty")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("palixy_planty"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("palix:palixy_planty"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.NAUSEA, 100, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(1f, 1f).speedFactor(2f).jumpFactor(2f).setLightLevel(s -> 1));
			setRegistryName("palixy_planty");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Attention a celui qui la casse !"));
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			PalixyplantyQuandLaPlanteEstDetruiteParUnJoueurProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
