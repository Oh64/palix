...
public class DirtPBlock extends PalixModElements.ModElement {
	@ObjectHolder("palix:alix_grass")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(2f, 15f).setLightLevel(s -> 0));
			setRegistryName("alix_grass");
		}
