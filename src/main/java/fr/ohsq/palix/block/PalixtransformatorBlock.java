...
import fr.ohsq.palix.gui.Palixgui1Gui;
import fr.ohsq.palix.PalixModElements;

@PalixModElements.ModElement.Tag
public class PalixtransformatorBlock extends PalixModElements.ModElement {
	@ObjectHolder("palix:palix_transformator_block")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("palix_transformator_block");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Palix Transformator");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new Palixgui1Gui.GuiContainerMod(id, inventory,
