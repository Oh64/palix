...
public class BoaBlock extends PalixModElements.ModElement {
	@ObjectHolder("palix:alix_boa")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.WOOD).hardnessAndResistance(5f, 15f).setLightLevel(s -> 0));
			setRegistryName("alix_boa");
		}
