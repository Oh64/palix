	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				PalixMod.LOGGER.warn("Failed to load dependency world for procedure PalixGui1Proc!");
			return;
		}
		...
		if ((new Object() {
			...
			if (XP >= 5) {
				...
				if (!world.isRemote()) {
					...
					if (mcserv != null)
						mcserv.getPlayerList().func_232641_a_(new StringTextComponent("A player does not have enough XP to operate his machine"),
