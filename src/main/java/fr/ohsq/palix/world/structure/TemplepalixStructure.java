...
public class TemplepalixStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 10000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("palix", "temple_palixnum2"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("templepalix"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("palix:templepalix"), configuredFeature);
		}
	}
