...
import fr.ohsq.palix.entity.renderer.PalixdefenderRenderer;
import fr.ohsq.palix.PalixModElements;

@PalixModElements.ModElement.Tag
public class PalixdefenderEntity extends PalixModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(PalixongletItemGroup.tab))
				.setRegistryName("palix_defender_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(PalixfragmentItem.block));
		}
