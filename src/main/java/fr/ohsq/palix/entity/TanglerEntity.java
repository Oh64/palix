...
import fr.ohsq.palix.entity.renderer.TanglerRenderer;
import fr.ohsq.palix.PalixModElements;

@PalixModElements.ModElement.Tag
public class TanglerEntity extends PalixModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12335829, -14922209, new Item.Properties().group(PalixongletItemGroup.tab))
				.setRegistryName("tangler_spawn_egg"));
	}
