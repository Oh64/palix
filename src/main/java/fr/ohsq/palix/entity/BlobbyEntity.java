...
import fr.ohsq.palix.entity.renderer.BlobbyRenderer;
import fr.ohsq.palix.PalixModElements;

@PalixModElements.ModElement.Tag
public class BlobbyEntity extends PalixModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -5056723, -10234076, new Item.Properties().group(PalixongletItemGroup.tab))
				.setRegistryName("blobby_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 20, 4, 6));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(7, new BreakBlockGoal(Blocks.COBBLESTONE, this, 5, (int) 3));
		}
